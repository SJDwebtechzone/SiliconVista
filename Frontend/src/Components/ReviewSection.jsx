    ...
    <section className="py-5" style={{ background: '#f8f9fa' }}>
      <Container>
        <div className="text-center mb-5">
          <h2 className="fw-bold display-6 mb-3" style={{ color: '#073738' }}>What Our Students Say</h2>
          <p className="text-muted fs-5">Real experiences from our successful candidates</p>
          ...
          {reviews.map(review => (
            ...
            >
              ...
              <Card.Body className="p-4 d-flex flex-column h-100">
                ...
                <p className="flex-grow-1 text-muted" style={{ fontSize: '1.05rem', lineHeight: '1.6', fontStyle: 'italic', zIndex: 1 }}>
                  "{review.review}"
                </p>
